...
const MOCK_LISTINGS: TeslaListing[] = [
  {
    ...
    autopilot: true,
    fsd: false,
    description: "One owner, clean carfax, all service records available.",
  },
  {
    ...
    autopilot: true,
    fsd: true,
    description: "FSD included, track mode, still under warranty.",
  },
  {
    ...
    autopilot: true,
    fsd: false,
    description: "Barely driven, essentially new condition.",
  },
  {
    ...
    autopilot: true,
    fsd: false,
    description: "7-seat configuration, second owner, minor accident on Carfax.",
  },
  {
    ...
    autopilot: true,
    fsd: false,
    description: "Premium package, dealer listing.",
  },
  {
    ...
    zip: "98101",
    source: "autotrader",
    sourceUrl: "https://www.autotrader.com/cars-for-sale/listing/123456",
    ...
    autopilot: true,
    fsd: true,
    description: "Transferable FSD, full warranty, immaculate condition.",
  },
  {
    ...
    zip: "33101",
    source: "autotrader",
    sourceUrl: "https://www.autotrader.com/cars-for-sale/listing/234567",
    sourceName: "AutoTrader",
    images: [
    ...
    autopilot: true,
    fsd: false,
    description: "Nearly new, like off-showroom condition.",
  },
  {
    ...
    zip: "02101",
    source: "cars.com",
    sourceUrl: "https://www.cars.com/vehicledetail/123456",
    sourceName: "Cars.com",
    images: [
    ...
    autopilot: true,
    fsd: false,
    description: "Track mode enabled, new tires.",
  },
];
